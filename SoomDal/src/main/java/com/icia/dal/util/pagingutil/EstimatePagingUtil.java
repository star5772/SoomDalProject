...
public class EstimatePagingUtil {
	// 페이지당 글의 개수
	private final static int COUNT_OF_BOARD_PER_PAGE = 6;
	// 블록당 페이지의 개수
	private final static int COUNT_OF_PAGE_PER_BLOCK = 5;
	
	// 일반글 페이징 또는 히트글 페이징
	public static PageToEstimate getPage(int pageno, int countOfBoard) {
		...
		return PageToEstimate.builder().startPage(startPage).endPage(endPage)
