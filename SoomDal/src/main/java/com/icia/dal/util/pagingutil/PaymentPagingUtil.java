...
public class PaymentPagingUtil {
	// 페이지당 글의 개수
	...
	// 일반글 페이징 또는 히트글 페이징
	public static PageToNowPayment getPage(int pageno, int countOfBoard) {
		...
		return PageToNowPayment.builder().startPage(startPage).endPage(endPage)
