	...
	<div style="border: 2px solid #F6F6F6; width: 700px; padding-left: 45px; margin-left: 200px;">
		<div class='readEstimate' style="padding: 30px 30px 30px 30px; margin: 0 auto;">
			<div id="pppprofile"> 
				...
				<div id="profile">
					<span style="font-weight: bold; margin-top: 100px; font-size: 15px;">제자이름</span><br>
				</div>
				<div id="date">
					<span>날짜</span>
				</div>
			...
			<div id="estimate">
				<div>
					...
					<div class="dap" style="width: 510px; height: 30px; margin-left: 20px; font-size: 13px;">
						<textarea rows="1" cols="80" style="border: 1px solid #dddddd;"></textarea>
					</div>
				</div>
				<div>
					...
					<div class="dap" style="width: 510px; height: 100px; margin-left: 20px;  font-size: 13px;">
						<textarea rows="5" cols="80" style="border: 1px solid #dddddd;"></textarea>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="btn">
			<button id="back" onclick="location.href='/dal/member/request/readToRequestForSend?'" >뒤로가기</button>
			&nbsp;&nbsp;
