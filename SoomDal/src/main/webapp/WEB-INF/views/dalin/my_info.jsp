   ...
   <div id="my_info_container">
	...
	<div id="my_info_container">
		...
		<div id="my_info_profile" style="height: 100px;">
			<a href="/dal/dalin/my_info_update" style="text-decoration: none">
				<div id="profile">
					<img src="/image/jeja.jpg" class="img-thumbnail"
				...
				<div id="user_info" style="display: inline-block; width: 530px; color: black;">
					...
					<div id="user_email">
						<span id="email_length">${myInfo.DEmail}</span><br> <span
							id="level_length">${myInfo.DLevelStr}</span>
					</div>
				</div> <img src="https://assets.cdn.soomgo.com/icons/icon-mypage-list-arrow.svg">
			</a>
		</div>
		<div>
			<hr>
			<span><h3>숨달 캐시</h3></span>
			<ul class="nav flex-column">
				<li class="nav-item"><a class="nav-link active" href="/dal/member/payment/store"><img src="https://assets.cdn.soomgo.com/icons/icon-mypage-store.svg" style="padding: 5px;"><span id="str" class="menu_span">스토어</span>
					<div class="store">
							<span>${myInfo.DCash} 캐시</span>
						</div>
						<img src="https://assets.cdn.soomgo.com/icons/icon-mypage-list-arrow.svg"></a>
					<hr></li>
				<li class="nav-item"><a class="nav-link" onclick="openChild()" href="#"><img src="https://assets.cdn.soomgo.com/icons/icon-mypage-dashboard.svg" style="padding: 5px;"><span class="menu_span">사용 내역</span><img src="https://assets.cdn.soomgo.com/icons/icon-mypage-list-arrow.svg"></a>
				</li>
			</ul>
		</div>
		<div id="menu">
			...
			<span><h3>레슨 관리</h3></span>
			<ul class="nav flex-column">
				<li class="nav-item"><a class="nav-link active" href="/dal/member/request/receiveRequest?dMno=${myInfo.DMno }"><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-quote-template.svg"
						style="padding: 5px;"><span class="menu_span">요청서</span><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-list-arrow.svg"></a>
					<hr></li>
				<li class="nav-item"><a class="nav-link"
					href="/dal/member/estimate/sendEstimateList?dMno=${myInfo.DMno }"><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-quote-template.svg"
						style="padding: 5px;"><span class="menu_span">견적서</span><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-list-arrow.svg"></a>
					<hr></li>
				<li class="nav-item"><a class="nav-link" href="#"><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-auto-quote.svg"
						style="padding: 5px;"><span class="menu_span">레슨 내역</span><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-list-arrow.svg"></a>
				</li>
			</ul>
		</div>
		...
		<div>
			...
			<ul class="nav flex-column">
				<li class="nav-item"><a class="nav-link active" href="#"><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-alarm.svg"
						style="padding: 5px;"><span class="menu_span">알림</span><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-list-arrow.svg"></a>
					<hr></li>
				<li class="nav-item"><a class="nav-link" href="#"><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-soomgo-info.svg"
						style="padding: 5px;"><span class="menu_span">공지사항</span><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-list-arrow.svg"></a>
					<hr></li>
				<li class="nav-item"><a class="nav-link" href="#"><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-soomgo-notice.svg"
						style="padding: 5px;"><span class="menu_span">달인 가이드</span><img
						src="https://assets.cdn.soomgo.com/icons/icon-mypage-list-arrow.svg"></a>
				</li>
			</ul>
		</div>
