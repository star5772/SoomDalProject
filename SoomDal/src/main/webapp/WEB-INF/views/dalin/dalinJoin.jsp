...
<div id="step-three-art"  style="display: none;" class="step-three">
	...
	<div id="service-art">
		...
		<input type="radio" name="detailFName" value="만화,웹툰,애니" class="radio" id="comic" style="display:none; background-color:rgb(234,234,234); "><label for="comic" class="detail-service-sport">만화,웹툰,애니 레슨</label>
		...
		<input type="radio" name="detailFName" value="가구,목공예"  class="radio"	id="woodworking" style="display:none;background-color:rgb(234,234,234);"><label for="woodworking" class="detail-service-sport ">가구,목공예 레슨</label>
