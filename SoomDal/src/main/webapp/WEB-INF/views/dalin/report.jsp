...
<div id="report_wrap" style="margin: 15px;">
	<div id="report_title">
		<h2 style="font-weight: bold; margin-bottom: 20px;">회원 신고하기</h2>	
	</div>
	<div id="report_body">
		<h4>신고 사유</h4>
		<div class="radio">
		...
		<div class="radio">
  			<label><input value="음란하거나 성적인 게시물" type="radio" name="optradio">음란하거나 성적인 리뷰</label>
		</div>
		<div class="radio">
  			<label><input value="정치인 관련 게시물" type="radio" name="optradio">정치인 관련 리뷰</label>
		</div>
		<div class="radio">
  			<label><input value="홍보성/불법광고 게시물" type="radio" name="optradio">홍보성/불법광고 리뷰</label>
		</div>
		<div class="radio">
