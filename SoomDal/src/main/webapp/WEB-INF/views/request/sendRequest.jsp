...
<body>
	...
	<div id="totalDiv">
		...
		<div id="step-one"  style="display: none" class="request">
			...
			<button class="com complete-step-one btn btn-warning" type="button" >다음 단계</button>
		</div>
		...
		<div id="step-two"  style="display:none;" class="request">
			...
			<button class="back back-to-prev-page btn btn-danger" type="button">이전 단계</button>
			<button class="com complete-step-one btn btn-warning" type="button" >다음 단계</button>
		</div>		
		...
		<div id="step-ten"  style="" class="request">
