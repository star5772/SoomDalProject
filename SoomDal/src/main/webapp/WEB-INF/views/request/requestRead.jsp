...
<h2>상세 요청서</h2>
	<div id="readRequestRead" style="border: 2px solid #F6F6F6; width: 700px; padding-left: 45px; margin-left: 200px;">
...
<sec:authorize access="hasRole('ROLE_JEJA')">
	...
	<div id="modu" style="padding: 30px 30px 30px 30px; margin: 0 auto;">
		...
		<div id="btn">
			<button class="btn btn-secondary" style="width:50px;" onclick="location.href='/dal/member/request/sendRequestList?jMno=${readRequest.JMno}'">목 록</button>
		</div>
</sec:authorize>
