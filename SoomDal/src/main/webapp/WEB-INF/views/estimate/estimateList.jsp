	...
	<c:forEach items="${receiveEstimate.list }" var="estimate">
		<div class="card">
			<div class="card-top">
				...
				<div><p>${estimate.RWriteDateStr }</p></div>
			</div>
			<div class="card-body">
			...
			<div class="card-bottom" id="button">
				<div><hr></div>
				<button onclick="location.href='/dal/member//estimate/readToReceiveEstimate?eNo=${readEstimate.eNo}'" class="btn btn-warning">요청서 보기</button>
			</div>
		</div>
	</c:forEach>
	</div>
